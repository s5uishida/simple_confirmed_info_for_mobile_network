...
| Role | Version | Commit & Date | OS | CPU<br>(Min) | Mem<br>(Min) | HDD<br>(Min) |
| --- | --- | --- | --- | --- | --- | --- |
| UPF | 2.2.1+<br>(+[patch](https://github.com/s5uishida/install_oai_upf/tree/main#get_patch)) | `cfc346c7dd11fd422e90e094ed75d8eb123f90ed`<br>2026.06.05 | Ubuntu<br>24.04 | 1 | 6GB | 20GB |
